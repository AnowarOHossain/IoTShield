...
ROOT_URLCONF = 'iotshield_backend.urls'
...
WSGI_APPLICATION = 'iotshield_backend.wsgi.application'
ASGI_APPLICATION = 'iotshield_backend.asgi.application'
...
# MQTT Topics
MQTT_TOPIC_SENSORS = os.getenv('MQTT_TOPIC_SENSORS', 'iotshield/sensors/data')
MQTT_TOPIC_ANOMALIES = os.getenv('MQTT_TOPIC_ANOMALIES', 'iotshield/anomalies')
MQTT_TOPIC_ALERTS = os.getenv('MQTT_TOPIC_ALERTS', 'iotshield/alerts')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'iotshield.log',
            'formatter': 'verbose',
        },
    },
    'root': {
