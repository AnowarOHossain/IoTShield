...
def test_gemini_detector():
    """Test the new Gemini-based anomaly detector"""
    print("\n" + "="*60)
    print("GEMINI ANOMALY DETECTOR TEST")
    print("="*60 + "\n")
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        print(f"\nCalling Gemini API...")
        result = detector.analyze_with_gemini(test_case['data'])
...
def test_with_recent_data():
    ...
    for i, sensor_data in enumerate(recent_data, 1):
        ...
        print(f"\nAnalyzing...")
        result = detector.analyze_with_gemini(data_dict)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Test Gemini Anomaly Detector')
    parser.add_argument(
        '--mode',
